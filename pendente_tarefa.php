	...
	<head>
		...
		<script>
			...
			function marcarUrgencia(id) {
				...
				location.href = 'urgencia_tarefa.php?acao=marcarUrgencia&id=' + id;	
			}
		</script>
	</head>
			...
			<div class="row">
					...
					<ul class="list-group">
						...
						<li class="list-group-item active">
							<a href="#" class="text-warning">
								<i class="fas fa-truck fa-lg mr-1"></i>
								Coletas Pendentes
							</a>
						...
						<li class="list-group-item strong"><a href="concluida_tarefa.php" class="text-success"><i class="fas fa-check-square fa-lg mr-4 text-success"></i>Coletas Concluídas</a></li>
						<?php if ($_SESSION['perfil'] == 0) { ?>
				...
				<div class="col-sm-8">
					<div class="container pagina bg-light mb-2 rounded">
						<div class="row">
							<div class="col">
								<h4 class="text-warning"><i class="fas fa-truck fa-lg mr-3"></i>Coletas Pendentes</h4>																
								<hr />
						<?php if ($_SESSION['perfil'] == 0) {?>
							<?php foreach ($tarefas as $tarefa => $value) { ?>
								<?php if($value['id_urgencia'] == 1) { ?>
								<div class="row mb-1 d-flex p-3 align-items-center tarefa border rounded p-2" style="background-color: #F7F8E0;">
						...
						<?php if ($_SESSION['perfil'] == 1) {?>		
							<?php foreach ($tarefas as $tarefa => $value) { ?>
								<?php if ($_SESSION['id'] == $value['id_user'] && $value['id_urgencia'] == 1) {?>
								<div class="row mb-1 d-flex align-items-center tarefa border rounded p-2" style="background-color: #F7F8E0;">
									<div class="col-sm-9 text-dark" id="tarefa_<?=$value['id']?>">
										<p class="mb-0">	
