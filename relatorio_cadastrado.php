<?php
	...
	$acao = 'pesquisarRelatorioRegistrado';
					...
					<div class="container pagina bg-light mb-2 rounded">
						<div class="row">
							<div class="col">
								...
								<hr />
								<h5 class="text-center">Pesquisa coletas <span class="text-warning">Cadastradas</span>:</h5>
								<form action="../controllers/relatorio_controler.php?acao=getDataPesquisaCadastrado" method="post" class="row justify-content-center">
									<input class="ml-3 form-control col-md-4 align-self-center" type="date" name="data_pesquisa" id="data_pesquisa">		
									<button id="pesquisa" type="submit" class="btn btn-lg col-md-2 ml-4 btn-warning" >Pesquisar</button>
								</form>
								<hr />						
										...
										<div class="table-responsive">
									      ...
									      <thead class="thead-dark">
									        <tr>
									          ...
									          <th>Cidade</th>
									          <th>Ender.</th>
									          <th class="text-info">Data Cadastrada</th>
									          <th>Data Coleta</th>
