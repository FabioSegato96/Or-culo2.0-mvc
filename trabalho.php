  ...
  <body>
    <nav class="navbar navbar-expand-md navbar-light pb-5" style="background-color: #DDF5DD">
        ...
        <div class="collapse navbar-collapse" id="navtarget3">
          ...
          <li class="nav-item mr-2 active"><a href="#" class="font-weight-bold lead nav-link">Nosso Trabalho</a></li>
      ...
      <h1 class="text-center display-2">Trabalho</h1>
      <div class="mb-5 p-2"> 
        <div class="row">
          <iframe class="bg-warning p-2 col-sm-5 m-auto border rounded" width="560" height="315" src="https://www.youtube.com/embed/U8Et0DFe2Co" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>
